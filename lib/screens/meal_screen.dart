...
class _MealsScreenState extends State<MealsScreen> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              Text(
                'Calories: ${widget.mealPlan.nutrients.calories.toString()} cal',
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                ),
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                'Carbs: ${widget.mealPlan.nutrients.carbohydrates.toString()} g',
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                ),
  ...
  _buildMealCard(Meals meal, int index) {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage(
                    'https://webknox.com/recipeImages/${meal.id}-556x370.jpg'),
                fit: BoxFit.cover,
              ),
              borderRadius: BorderRadius.circular(15.0),
              boxShadow: [
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          Meals meal = widget.mealPlan.meals[index - 1];
